...
UPDATE `item_animations` set cstr_id_animation='' where cstr_id_animation is null
ALTER TABLE `item_animations` CHANGE COLUMN `cstr_id_animation` `cstr_animation` VARCHAR(200) NOT NULL DEFAULT '';
UPDATE `item_animations` set cstr_animation=(select string from common_strings where id=cstr_animation);
UPDATE `item_stats` set cstr_id_gfx_mesh='' where cstr_id_gfx_mesh is null
ALTER TABLE `item_stats` CHANGE COLUMN `cstr_id_gfx_mesh` `cstr_gfx_mesh` VARCHAR(200) NOT NULL DEFAULT '';
UPDATE `item_stats` set cstr_gfx_mesh=(select string from common_strings where id=cstr_gfx_mesh);
UPDATE `item_stats` set cstr_id_gfx_icon='' where cstr_id_gfx_icon is null
ALTER TABLE `item_stats` CHANGE COLUMN `cstr_id_gfx_icon` `cstr_gfx_icon` VARCHAR(200) NOT NULL DEFAULT '';
UPDATE `item_stats` set cstr_gfx_icon=(select string from common_strings where id=cstr_gfx_icon);
UPDATE `item_stats` set cstr_id_gfx_texture='' where cstr_id_gfx_texture is null
ALTER TABLE `item_stats` CHANGE COLUMN `cstr_id_gfx_texture` `cstr_gfx_texture` VARCHAR(200) NOT NULL DEFAULT '';
UPDATE `item_stats` set cstr_gfx_texture=(select string from common_strings where id=cstr_gfx_texture);
UPDATE `item_stats` set cstr_id_part='' where cstr_id_part is null
ALTER TABLE `item_stats` CHANGE COLUMN `cstr_id_part` `cstr_part` VARCHAR(200) NOT NULL DEFAULT '';
UPDATE `item_stats` set cstr_part=(select string from common_strings where id=cstr_part);
UPDATE `item_stats` set cstr_id_part_mesh='' where cstr_id_part_mesh is null
ALTER TABLE `item_stats` CHANGE COLUMN `cstr_id_part_mesh` `cstr_part_mesh` VARCHAR(200) NOT NULL DEFAULT '';
UPDATE `item_stats` set cstr_part_mesh=(select string from common_strings where id=cstr_part_mesh);
UPDATE `quests` set cstr_id_icon='' where cstr_id_icon is null
ALTER TABLE `quests` CHANGE COLUMN `cstr_id_icon` `cstr_icon` VARCHAR(200) NOT NULL DEFAULT '';
UPDATE `quests` set cstr_icon=(select string from common_strings where id=cstr_icon);
UPDATE `race_info` set cstr_id_mesh='' where cstr_id_mesh is null
ALTER TABLE `race_info` CHANGE COLUMN `cstr_id_mesh` `cstr_mesh` VARCHAR(200) NOT NULL DEFAULT '';
UPDATE `race_info` set cstr_mesh=(select string from common_strings where id=cstr_mesh);
UPDATE `race_info` set cstr_id_base_texture='' where cstr_id_base_texture is null
ALTER TABLE `race_info` CHANGE COLUMN `cstr_id_base_texture` `cstr_base_texture` VARCHAR(200) NOT NULL DEFAULT '';
...
UPDATE `traits` set cstr_id_mesh='' where cstr_id_mesh is null
ALTER TABLE `traits` CHANGE COLUMN `cstr_id_mesh` `cstr_mesh` VARCHAR(200) NOT NULL DEFAULT '';
UPDATE `traits` set cstr_mesh=(select string from common_strings where id=cstr_mesh);
UPDATE `traits` set cstr_id_material='' where cstr_id_material is null
ALTER TABLE `traits` CHANGE COLUMN `cstr_id_material` `cstr_material` VARCHAR(200) NOT NULL DEFAULT '';
UPDATE `traits` set cstr_material=(select string from common_strings where id=cstr_material);
UPDATE `traits` set cstr_id_texture='' where cstr_id_texture is null
ALTER TABLE `traits` CHANGE COLUMN `cstr_id_texture` `cstr_texture` VARCHAR(200) NOT NULL DEFAULT '';
