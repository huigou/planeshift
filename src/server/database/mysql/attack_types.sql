...
CREATE TABLE `attack_types` (
  ...
  `weaponName` VARCHAR(60) DEFAULT NULL COMMENT 'filled in for a very specific weapon with special attack, either this or weapon type should always be filled in', 
  `weaponType` VARCHAR(100) DEFAULT NULL COMMENT 'more than one required weapon type may be listed. Separate each weapon type with a space',
