...
INSERT INTO `action_locations` VALUES (13,0,'One Two Three','NPCroom','npc1_Box07',0,-16.17,0.70,-217.06,4294967295,4,'SELECT','EXAMINE','<Examine><GameBoard Name=\'One Two Three\' EndGame=\'Yes\' Script=\'rain\' /><Description>Tests specific pieces rule. Put tile 1 in 0,0, tile 2 in 1,0 and tile 3 in 2,0</Description></Examine>','Y');
