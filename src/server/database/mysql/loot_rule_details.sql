...
CREATE TABLE  `planeshift`.`loot_rule_details` (
  ...
  `min_items` int(10) unsigned NOT NULL DEFAULT '1' COMMENT 'The minimum amount of these items which could be created',
  `max_items` int(10) unsigned NOT NULL DEFAULT '1' COMMENT 'The maximum amount of these items which could be created',
