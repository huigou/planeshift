 ...
 *
 */
#ifndef psAttackRange_HEADER
#define psAttackRange_HEADER
...
class psAttackRange: public psAttack
{
public:
    ...
    bool CalculateSuccess(psCombatAttackGameEvent* event, float range);
...
private:
    ...
    float PowerLevel(psCharacter* attacker, psItem* weapon, float range) const;
