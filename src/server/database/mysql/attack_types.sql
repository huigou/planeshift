...
INSERT INTO `attack_types` (`id`, `name`, `weaponName`, `weaponType`, `onehand`, `stat`) VALUES (1, 'Assassination', NULL, 'SWORD KNIVES', 1, 1);
INSERT INTO `attack_types` (`id`, `name`, `weaponName`, `weaponType`, `onehand`, `stat`) VALUES (2, 'Archery', NULL, 'BOW CROSSBOW', 1, 1);
INSERT INTO `attack_types` (`id`, `name`, `weaponName`, `weaponType`, `onehand`, `stat`) VALUES (3, 'Barbaric', NULL, 'SWORD CLAYMORE POLEARM HAMMER AXE', 0, 0);
INSERT INTO `attack_types` (`id`, `name`, `weaponName`, `weaponType`, `onehand`, `stat`) VALUES (4, 'Long Bow Special', 'Long Bow', NULL, 1, 1);
