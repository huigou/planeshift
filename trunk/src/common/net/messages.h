 ...
 *  messages.
 */
class psMountingMessage : public psMessageCracker
{
public:

    /** @brief Constuct a new mounting message to go on the network.
     *
     * FIX THIS DESC
     * This will build an equipment message for any player that has
     * changed their equipment.  Should only be generated by the server.
     *
     * @param clientNum Client destination.
     * @param mountid   The entity that is being mounted
     * @param riderid   The entity that mounts
     *
     */
    psMountingMessage( uint32_t clientNum,
                        EID mountid,
                        EID riderid,
                        bool mounting );
    ...
    /// Crack this message off the network.
    psMountingMessage( MsgEntry* message );
