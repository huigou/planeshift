...
INSERT INTO `action_locations` VALUES (4,0,'HealingTree','NPCroom','_g_treetop02big_02',0,0,0,0,4,'PROXIMITY','SCRIPT','flame_damage','Y');
INSERT INTO `action_locations` VALUES (5,0,'woodbox','NPCroom','smith_woodbox',0,0,0,0,0,'SELECT','EXAMINE','<Examine>\n<Container ID=\'80\'/>\n<Description>A Box full of books</Description>\n</Examine>','Y');
INSERT INTO `action_locations` VALUES (6,0,'Smith Forge','NPCroom','smith_furnace',0,0,0,0,0,'SELECT','EXAMINE','<Examine>\n<Container ID=\'115\'/>\n<Description>A smith forge, ready to heat materials</Description>\n</Examine>','Y');
INSERT INTO `action_locations` VALUES (7,0,'Anvil','NPCroom','smith_anvil',0,0,0,0,0,'SELECT','EXAMINE','<Examine>\n<Container ID=\'116\'/>\n<Description>An anvil used to forge items</Description>\n</Examine>','Y');
...
INSERT INTO `action_locations` VALUES (9,0,'The wall home','NPCroom1','_s_npcroom02',0,-64,0,-116,0,'SELECT','EXAMINE','<Examine><Entrance Type=\'ExitActionID\' /><Description>Way back home</Description></Examine>','Y');
INSERT INTO `action_locations` VALUES (10,0,'ownedbox','NPCroom','smith_woodplank',0,0,0,0,0,'SELECT','EXAMINE','<Examine>\n<Container ID=\'82\'/>\n<Description>A Box owned by the merchant</Description>\n</Examine>','Y');
