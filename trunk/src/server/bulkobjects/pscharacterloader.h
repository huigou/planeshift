...
public:
    ...
    /// Initializes settings related to this class.  Call this before using any functions.
    bool Initialize();
     ...
     *         in the future.
     *  @param uid The unique ID of the character to load data for.  Usually obtained from the account.
     ...
     *
     *  @param charID The unique ID of the character to erase data for.  Usually obtained from the account.
     *
