...
EEditParticleEditToolbox::EEditParticleEditToolbox() : scfImplementationType(this)
{
}

EEditParticleEditToolbox::~EEditParticleEditToolbox()
{
}

void EEditParticleEditToolbox::Update(unsigned int elapsed)
{
}

size_t EEditParticleEditToolbox::GetType() const
{
    return T_PARTICLES_EDIT;
}

const char * EEditParticleEditToolbox::GetName() const
{
    return "Particle Editor";
}
    
int EEditParticleEditToolbox::SortTextBox(pawsWidget * widgetA, pawsWidget * widgetB)
{
...
void EEditParticleEditToolbox::FillList(iParticleSystemFactory* partsysfact)
{
    EEditParticleEditToolbox::partsysfact = partsysfact;
...
#if 0
void EEditParticleEditToolbox::SelectEffect(const csString & effectName)
{
...
bool EEditParticleEditToolbox::PostSetup()
{
...
bool EEditParticleEditToolbox::OnButtonPressed(int mouseButton, int keyModifier, pawsWidget* widget)
{
    ...
    {
	FillList(partsysfact);
        return true;
    }
    return false;
}

void EEditParticleEditToolbox::OnListAction(pawsListBox* selected, int status)
{
