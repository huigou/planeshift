...
csString psCharApprovedMessage::ToString(AccessPointers * /*access_ptrs*/)
{
    csString msgtext;
...
csString psCharRejectedMessage::ToString(AccessPointers * /*access_ptrs*/)
{
    csString msgtext;
...
csString psCharVerificationMesg::ToString(AccessPointers * /*access_ptrs*/)
{
    csString msgtext;
...
csString psCharUploadMessage::ToString(AccessPointers * /*access_ptrs*/)
{
    csString msgtext;
...
csString psCreationChoiceMsg::ToString(AccessPointers * /*access_ptrs*/)
{
    csString msgtext;
...
csString psLifeEventMsg::ToString(AccessPointers * /*access_ptrs*/)
{
    csString msgtext;
