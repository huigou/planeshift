...
) AUTO_INCREMENT=208 /*!40100 DEFAULT CHARSET=utf8*/;
...
REPLACE INTO "quests" ("id", "name", "task", "cstr_id_icon", "flags", "master_quest_id", "minor_step_number", "player_lockout_time", "quest_lockout_time", "category", "prerequisite") VALUES
...
REPLACE INTO "quests" ("id", "name", "task", "cstr_id_icon", "flags", "master_quest_id", "minor_step_number", "player_lockout_time", "quest_lockout_time", "category", "prerequisite") VALUES
	('207','Acquire Lapar','Get the things he wants to get your Lapar','0',0,NULL,0,0,0,'TestAudio','');
